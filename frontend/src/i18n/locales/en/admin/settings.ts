    ...
    settings: {
      ...
      features: {
        ...
        riskControl: {
          ...
          cyberSessionBlockGroups: 'Group overrides',
          cyberSessionBlockGroupsHint: 'An entry overrides the global switch for that active group. Unlisted groups use the global setting.',
          cyberSessionBlockNoGroups: 'No active groups available.',
        },
        affiliate: {
