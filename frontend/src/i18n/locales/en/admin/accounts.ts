export default {
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintModeDesc: 'Bind each OAuth account to one stable installation while assigning each client session an independent, consistent root session/thread identity. New and existing OAuth accounts use device + session convergence by default, with a distinct identity for every turn.',
