export default {
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintModeDesc: 'Bind each OAuth account to stable installation, session, and thread identities. New and existing OAuth accounts use full convergence by default while retaining a distinct identity for every turn.',
        codexFingerprintOff: 'Off (passthrough)',
        codexFingerprintDevice: 'Device only',
        codexFingerprintSession: 'Device + Session',
        codexFingerprintFull: 'Full convergence (default)',
