export default {
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintModeDesc: '多人共享同一 OAuth 账号时，将各用户的设备/会话标识收敛为账号级恒定值，减少上游可见的设备数和会话数。新账号默认仅绑定设备，存量账号保持原设置；部分账号开启更强收敛后出现过额度缩水，请按自己的实测结果选择。',
        codexFingerprintOff: '关闭（透传）',
        codexFingerprintDevice: '仅设备（新账号默认）',
