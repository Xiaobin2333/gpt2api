...
func TestPrepareCodexFingerprintExtraForCreateDefaultsNewOAuthToFull(t *testing.T) {
...
func TestPrepareCodexFingerprintExtraForCreateNormalizesInvalidModeToFull(t *testing.T) {
