...
func TestSanitizeCodexOAuthJSONBodyForSchemaEnforces01540TopLevelFields(t *testing.T) {
	tests := []struct {
		name          string
...
func TestSanitizeCodexOAuthJSONBodyPreservesValidated01540WSTraceMetadata(t *testing.T) {
...
func TestCodex01540TUIStripsUnavailableAttestationHeader(t *testing.T) {
...
func TestSanitizeCodexOAuthTurnMetadataRejectsInvalid01540FieldTypes(t *testing.T) {
